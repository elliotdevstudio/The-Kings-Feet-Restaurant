            ...
            var positionImage = function positionImage(imageEl) {
              ...
              var getRelativeOffset = function getRelativeOffset() {
                ...
                if (overflowWidth === 0) {
                  ...
                  valueX =
                    Math.max(Math.min(targetWidth * focalPointX - parentDimensionWidth * 0.5, overflowWidth), 0) /
                    overflowWidth
                }
                ...
                if (overflowHeight === 0) {
                  ...
                  valueY =
                    Math.max(Math.min(targetHeight * focalPointY - parentDimensionHeight * 0.5, overflowHeight), 0) /
                    overflowHeight
                }
